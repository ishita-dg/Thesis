...
\chapter{Amortization: Re-use of previous solutions}
...
%Previous work
%%%%%%%%%%%%%%%%%%
\section{Hypothesis generation and amortization}
...
\hline
\textbf{Name}&\textbf{Description}& \textbf{References}\\\hline
...
$P (\text{A}_{atypical} \cup \text{B}) > P (\text{A}_{atypical}) + P(\text{B})$ & \cite{sloman04,hadjichristidis1999opening} \\\\ \hline
\end{tabular}
\end{table}
...
\bf{Cue} & \bf{$\mathcal{Q}1$} & \bf{$\mathcal{Q}1$-Typical} & \bf{$\mathcal{Q}1$-Atypical}& \bf{$\mathcal{Q}2$}\\\hline

Table & C & chair, computer, curtain & cannon, cow, canoe & C or R\\\hline

Telephone & D & display case, dresser, desk & drinking fountain, dryer, dome & D or L\\\hline

Rug & B & book, bouquet, bed & bird, buffalo, bicycle & B or S\\\hline

Chair & P & painting, plant, printer & porch, pie, platform & P or A\\\hline

Sink & T & table, towel, toilet & trumpet, toll gate, trunk &T or E\\\hline
...
\bf{Cue} & \bf{$\mathcal{Q}1$} & \bf{$\mathcal{Q}1$-Typical} & \bf{$\mathcal{Q}1$-Atypical}& \bf{$\mathcal{Q}2$-Partial overlap} &\bf{$\mathcal{Q}2$-No overlap}\\\hline

Table & C & chair, computer, curtain & cannon, cow, canoe & C or R &T or R\\\hline

Telephone & D & display case, dresser, desk & drinking fountain, dryer, dome & D or L& G or L\\\hline

Rug & B & book, bouquet, bed & bird, buffalo, bicycle & B or S&D or S\\\hline

Chair & P & painting, plant, printer & porch, pie, platform & P or A&M or A\\\hline

Sink & T & table, towel, toilet & trumpet, toll gate, trunk &T or E&F or E\\\hline
...
\centering
\begin{tabular}{l|c|l|l|c|c}
\bf{Cue1} & \bf{$\mathcal{Q}1$} & \bf{$\mathcal{Q}1$-Typical} & \bf{$\mathcal{Q}1$-Atypical}& \bf{Cue2-sim (KL)} & \bf{Cue2-diff (KL)}\\\hline

Rug & B & book, bouquet, bed & bird, buffalo, bicycle & Curtain (0.080)& Car (8.658)\\\hline

Chair & P & painting, plant, printer & porch, pie, platform & Book (0.031) & Road (8.508)\\\hline

Sink & T & table, towel, toilet & trumpet, toll gate, trunk & Counter (0.001)& Sidewalk (8.503)\\\hline
