...
\chapter{Approximations at run-time}
%
...
\label{tab:biases}
\begin{tabular}{p{.25\textwidth}>{\raggedright}p{.45\textwidth}p{.20\textwidth}}
\toprule
...
\begin{tabular}{>{\centering}m{1.6cm}>{\centering}m{1.1cm}>{\centering}m{0.4cm}>{\centering}m{1.5cm}>{\centering}m{0.6cm}>{\centering}m{1.5cm}>{\centering}m{1.2cm}>{\centering}m{1.1cm}>{\centering}m{1.6cm}c} 
 ...
 & lung cancer & TB & respiratory flu & cold & gastro-enteritis & stomach cancer & stomach flu & food poisoning & base \\\\
\midrule
...
\label{tab:scenarios}
  ...
  \begin{center} 
\begin{tabular}{p{.12\textwidth} >{\centering}p{.08\textwidth} >{\raggedright}p{.32\textwidth} >{\raggedright}p{.36\textwidth}}
  \toprule
\bf{Cue object} & \bf{Letter} & \bf{Unpacked-typical} & \bf{Unpacked-atypical}\tabularnewline\tabularnewline
\midrule
Pillow & A & armchair, alarm clock, apple & arch, airplane, artichokes\tabularnewline\tabularnewline
Rug & B & book, bouquet, bed & bird, buffalo, bicycle\tabularnewline\tabularnewline
Table & C & chair, computer, curtain & cannon, cow, canoe\tabularnewline\tabularnewline
Telephone & D & display case, dresser, desk & drinking fountain, dryer, dome\tabularnewline\tabularnewline
Computer & E & envelope,electrical outlet, end table & eggplant, electric mixer, elevator door\tabularnewline\tabularnewline
Armchair & F & fireplace, filing cabinet, fan& fire hydrant, fountain, fish tank\tabularnewline\tabularnewline
Stove & L & light, lemon, ladle& leavers, ladder, lichen\tabularnewline\tabularnewline
Chair & P & painting, plant, printer& porch, pie, platform\tabularnewline\tabularnewline
Bed & R & rug, remote control, radio & railroad, recycling bins, rolling pin\tabularnewline\tabularnewline
Kettle & S & stove, shelves, soap& suitcase, shoe, scanner\tabularnewline\tabularnewline
Sink & T & table, towel, toilet & trumpet, toll gate, trunk\tabularnewline\tabularnewline
Lamp & W & window, wardrobe, wine rack & wheelbarrow, water fountain, windmill\tabularnewline\tabularnewline
\bottomrule
...
\begin{tabular}{p{.18\textwidth} p{.18\textwidth} p{.08\textwidth} >{\raggedright}p{.25\textwidth} >{\raggedright}p{.25\textwidth}}
  \toprule
\bf{Cue object 1}&\bf{Cue object 2}&\bf{Letter}&\bf{Unpacking 1} &\bf{Unpacking 2}\tabularnewline\tabularnewline
\midrule
Pillow & Faucet & B & bed skirt, bedspread\ & bucket, bread\tabularnewline\tabularnewline
Road & Sink & C & cabin, crosswalk & cup, coffee maker\tabularnewline\tabularnewline
...
\label{tab:compare}
\begin{tabular}{>{\centering}p{.28\textwidth}>{\centering}p{.20\textwidth}>{\centering}p{.20\textwidth}>{\centering}p{.20\textwidth}}
\toprule
\textbf{Effect} & \multicolumn{3}{>{\centering}p{0.60\textwidth}}{\textbf{Stochastic Sampling Variants}} 
